...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_event__ = __webpack_require__(2219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_split_view_split_view__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_rich_text_editor_rich_text_editor_ts__ = __webpack_require__(979);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_calendar__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_calendar_offline__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_helper__ = __webpack_require__(975);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__providers_calendar_sync__ = __webpack_require__(416);
// (C) Copyright 2015 Martin Dougiamas
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonCalendarEditEventPage = /** @class */ (function () {
    function AddonCalendarEditEventPage(navParams, navCtrl, translate, domUtils, textUtils, timeUtils, eventsProvider, groupsProvider, sitesProvider, coursesProvider, utils, calendarProvider, calendarOffline, calendarHelper, calendarSync, fb, syncProvider, svComponent) {
        ...
        this.component = __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].COMPONENT;
        this.loaded = false;
    ...
    AddonCalendarEditEventPage.prototype.fetchData = function (refresh) {
        ...
        return this.calendarProvider.getAccessInformation(this.courseId).then(function (info) {
            ...
            if (_this.eventId && !_this.gotEventData) {
                ...
                promises.push(_this.calendarSync.waitForSync(__WEBPACK_IMPORTED_MODULE_18__providers_calendar_sync__["a" /* AddonCalendarSyncProvider */].SYNC_ID).then(function () {
                    // Do not block if the scope is already destroyed.
                    if (!_this.isDestroyed) {
                        _this.syncProvider.blockOperation(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].COMPONENT, _this.eventId);
                    }
                    var promises = [];
            ...
            return Promise.all(promises).then(function () {
                if (!_this.eventTypeControl.value) {
                    ...
                    if (types.course) {
                        _this.eventTypeControl.setValue(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_COURSE);
                    }
                    else {
    ...
    AddonCalendarEditEventPage.prototype.submit = function () {
        ...
        var error;
        if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_COURSE && !formData.courseid) {
            error = 'core.selectacourse';
        }
        else if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_GROUP && !formData.groupcourseid) {
            error = 'core.selectacourse';
        }
        else if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_GROUP && !formData.groupid) {
            error = 'core.selectagroup';
        }
        else if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_CATEGORY && !formData.categoryid) {
        ...
        if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_COURSE) {
            data.courseid = formData.courseid;
        }
        else if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_GROUP) {
            data.groupcourseid = formData.groupcourseid;
            data.groupid = formData.groupid;
        }
        else if (formData.eventtype == __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].TYPE_CATEGORY) {
    ...
    AddonCalendarEditEventPage.prototype.returnToList = function (event) {
        ...
        if (this.eventId > 0) {
            ...
            this.eventsProvider.trigger(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].EDIT_EVENT_EVENT, data, this.currentSite.getId());
        }
        else {
            if (event) {
                var data = {
                ...
                this.eventsProvider.trigger(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].NEW_EVENT_EVENT, data, this.currentSite.getId());
            }
            else {
                this.eventsProvider.trigger(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].NEW_EVENT_DISCARDED_EVENT, {}, this.currentSite.getId());
            }
        }
    ...
    AddonCalendarEditEventPage.prototype.unblockSync = function () {
        if (this.eventId) {
            this.syncProvider.unblockOperation(__WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */].COMPONENT, this.eventId);
        }
    };
    /**
     * Page destroyed.
    ...
    AddonCalendarEditEventPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["t" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_15__providers_calendar__["a" /* AddonCalendarProvider */],
            __WEBPACK_IMPORTED_MODULE_16__providers_calendar_offline__["a" /* AddonCalendarOfflineProvider */],
            __WEBPACK_IMPORTED_MODULE_17__providers_helper__["a" /* AddonCalendarHelperProvider */],
            __WEBPACK_IMPORTED_MODULE_18__providers_calendar_sync__["a" /* AddonCalendarSyncProvider */],
