...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__day__ = __webpack_require__(2218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_calendar__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_calendar_offline__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_helper__ = __webpack_require__(975);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_moment__ = __webpack_require__(7);
...
var AddonCalendarDayPage = /** @class */ (function () {
    ...
    AddonCalendarDayPage.prototype.openEdit = function (eventId) {
        ...
        if (eventId) {
            ...
            params.timestamp = __WEBPACK_IMPORTED_MODULE_15_moment__().year(this.year).month(this.month - 1).date(this.day).unix() * 1000;
        }
        if (this.courseId) {
    ...
    AddonCalendarDayPage.prototype.calculateCurrentMoment = function () {
        this.currentMoment = __WEBPACK_IMPORTED_MODULE_15_moment__().year(this.year).month(this.month - 1).date(this.day);
    };
    /**
